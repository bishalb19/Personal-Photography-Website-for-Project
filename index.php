        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1><br>Welcome to</br> <br><small>Rezoan Ahmed Photography</small></br></h1>
                    <div class="alert alert-dismissable alert-warning">
                        <button data-dismiss="alert" class="close" type="button">&times;</button>
                        Welcome to Rezoan Ahmed Photography! Feel free to review all pages and give a feedback. 
                        <br />
                        This is my Flickr id. <a href="https://www.flickr.com/photos/75822060@N02/">Flickr</a> .Please take a visit.
                    </div>
                </div>
            </div>
...
<img class="mySlides w3-animate-fading" src="a.jpg" style="width:100%">
<img class="mySlides w3-animate-fading" src="b.jpg" style="width:100%">
<img class="mySlides w3-animate-fading" src="c.jpg" style="width:100%">
<img class="mySlides w3-animate-fading" src="d.jpg" style="width:100%">
